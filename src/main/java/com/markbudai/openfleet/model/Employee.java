...
public class Employee {
    ...
    public Employee(long id, String firstName, String lastName, LocalDate dateOfBirth, Location placeOfBirth, String socialInsuranceNo, String mothersName, String taxNo, String driversCardNo, Location placeOfLiving) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (getDriversCardNo() != null ? !getDriversCardNo().equals(employee.getDriversCardNo()) : employee.getDriversCardNo() != null)
            return false;
        return getPlaceOfLiving() != null ? getPlaceOfLiving().equals(employee.getPlaceOfLiving()) : employee.getPlaceOfLiving() == null;
    }
